...
function init(){
    ...
    document.querySelector("#myButton").addEventListener("click",generate.bind(this, 1))

    document.querySelector("#my2ndButton").addEventListener("click",generate.bind(this, 5))
}
